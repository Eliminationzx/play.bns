...
object ActorNameFactory {
  def makeSupervisorName[T <: Supervisor : ClassTag](port: Int): String = Erasure[T].getSimpleName + "-" + port
  def makeNetworkServerName[T: ClassTag](port: Int): String = Erasure[T].getSimpleName + "-" + port
